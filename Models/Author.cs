...
public class Author
{
    ...
    [RegularExpression(@"^[А-Яа-яA-Za-z]+$", ErrorMessage = "Фамілія може містити тільки літери.")]
    public string LastName { get; set; }
    
    [Required(ErrorMessage = "Імʼя є обовʼязковим.")]
    [RegularExpression(@"^[А-Яа-яA-Za-z]+$", ErrorMessage = "Імʼя може містити тільки літери.")]
    public string FirstName { get; set; }
    
    [RegularExpression(@"^[А-Яа-яA-Za-z]*$", ErrorMessage = "По-батькові може містити тільки літери.")]
